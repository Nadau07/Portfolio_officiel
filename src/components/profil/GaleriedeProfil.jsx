...
/**
 *
 * @returns {JSX} : Composant affichant l'animation des images, ainsi que les passions.
 *
 */
  ...
  return (
    <div className="galerieprofil">
      ...
      <div className="passions">
        <h3 className="passions_title">Pour me connaître un peu plus...</h3>
        {arrowVisible && (
          <img
            src={parIci}
            className="passion_icon"
            alt="rubrique passion"
