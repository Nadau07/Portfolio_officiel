...
export const DataProjets = [
  {
    ...
    scenario:
      "La CTO de l'agence Kasa, a demandée une refonte totale du site, en JavaScript, avec React coté front-end.",
    objectif: [
  ...
  },
  {
    ...
    scenario:
      "Je propose à MME Carducci, d'optimiser son site au niveau des images, et du code . Grâce à cela, son site ne sera plus long au chargement,et elle gagnera en visibilité car elle aura un meilleur référencement (SEO).",
    objectif: [
      "Amélioration du chargement et de l'accessibilité du site",
      "Mise  en place du référencement local et SEO.",
    ],
...

  {
    ...
    scenario:
      "On m'a demandé de développer un site en mobile first, qui répertorie les menus de restaurants gastronomiques",
    objectif: [
      "Intégrer une maquette en mobile-first",
      "Mettre en œuvre des animation CSS ",
    ],
    tags: ["HTML", "SASS"],
  ...
  },
  {
    ...
    scenario:
      "La start-up Booki me contacte pour développer leurs site internet en respectant les differentes maquettes de Loïc, l'UI designer.",
...

  {
    ...
    scenario:
      "Argent Bank est une nouvelle banque en ligne qui souhaite percer dans le secteur bancaire, Milla, la cheffe de projet, me demande de creer l'application web complète et responsive avec React. Elle me demande aussi d'utiliser Redux pour gérer le state de l'ensemble de l'application.",
    objectif: [
  ...
  },
  {
    ...
    scenario:
      "L'agence 724Events me contacte pour une mission: elle souhaite publier la nouvelle version de son site vitrine, mais malheureusement l'ancien développeur a dû abandonner le projets pour des raisons personnelles. Le site est fonctionnel, mais quelques bugs entravent le bon usage des visiteurs, il compte donc sur moi pour finaliser le travail. ",
    objectif: [
      "Débugger un site web grâce aux Chromes DevTools",
      "Mise en place de test",
      "Rédaction d'un cahier de recette pour tester un site",
    ],
